    ...
    try {
      ...
      switch (error.code) {
        ...
        case "auth/email-already-in-use":
          errorMessage = "Email này đã được sử dụng. Hãy thử một email khác.";
          break;
        ...
        <div className="bg-gray-950 rounded-lg">
          ...
          >
            <div className="border-b border-b-white/10 pb-5">
              ...
              Bạn cần cung cấp thông tin cần thiết để đăng ký với
              chúng tôi.
              </p>
            </div>
            <div className="border-b border-b-white/10 pb-5">
              <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-6">
                <div className="sm:col-span-3">
                  <Label title="Họ" htmlFor="firstName" />
                  <input
                    type="text"
                    name="firstName"
                ...
                <div className="sm:col-span-3">
                  <Label title="Tên" htmlFor="lastName" />
                  <input
                    type="text"
                    name="lastName"
                    className="block w-full rounded-md border-0 bg-white/5 py-1.5 px-4 outline-none text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-skyText sm:text-sm sm:leading-6 mt-2"
                ...
                <div className="sm:col-span-4">
                  <Label title="Mật khẩu" htmlFor="password" />
                  <input
                    type="password"
                    name="password"
                    className="block w-full rounded-md border-0 bg-white/5 py-1.5 px-4 outline-none text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-skyText sm:text-sm sm:leading-6 mt-2"
